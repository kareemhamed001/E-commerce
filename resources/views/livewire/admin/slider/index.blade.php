                            ...
                            <table class="table container-fluid table-bordered table-striped">
                                ...
                                @forelse($sliders as $slider)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-success my-1" href="{{url('admin/slider/'.$slider->id.'/edit')}}" >Edit</a>
                                            <a class="btn btn-sm btn-danger  my-1" data-bs-toggle="modal" data-bs-target="#deleteSliderModal" wire:click="delete_slider({{$slider->id}})">Delete</a>
                                        </td>
                                    </tr>
                                @empty
                                @endforelse
