                    ...
                    <div class="product-view">
                            ...
                            @if($product->productColors->count()>0)
                                @if($product->productColors)
                                    @foreach($product->productColors as $color)
                                            <input type="radio" name="product_color_selected" value="{{$color->id}}" wire:model="color_selected">{{$color->color->name}}
                                    @endforeach
                                @endif
                        ...
                        <div class="mt-2">
                            <div class="input-group">
                                ...
                                <input type="text" value="{{$product_quantity}}" class="input-quantity" wire:model="product_quantity"/>
